...
# training set info
training_set_true_df <- read.table('/Users/rtan/terra_rt2776/CNV_Espresso/training_set/training_set_true_rare.txt',header = TRUE)
training_set_false_df <- read.table('/Users/rtan/terra_rt2776/CNV_Espresso/training_set/training_set_false_rare.txt',header = TRUE)

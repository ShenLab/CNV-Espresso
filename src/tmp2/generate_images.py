...
flanking        = sys.argv[6]
split_img       = False #sys.argv[8]
try:
    sge_task_id = int(sys.argv[7])
except:
    sge_task_id = 'all'
...
figure_left = 24437924
figure_right= 24474887
...
RD_cnv_region_df = fetchRDdata_byTabix(RD_norm_dir, sampleID, cnv_chr, figure_left, figure_right, fixed_win_num)
...
if not os.path.exists(ref_samples_file):
    ...
    exit(0)
reference_RD_df = fetchRefRDdata_byTabix(ref_samples_file, cnv_chr, figure_left, figure_right, fixed_win_num, corr_threshold)
